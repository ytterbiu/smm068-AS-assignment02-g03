...
```{r q4-bermudan-tree-plot, echo=FALSE, fig.width=7, fig.height=8.3, fig.cap="Bermudan put option price tree. Red nodes marked (E) identify states where the intrinsic payoff strictly exceeds the discounted continuation value, making early exercise optimal. This boundary emerges at step 3 and widens toward maturity, concentrated in the lower portion of the tree where the put is deep 'in-the-money' and the financing gain from receiving $K$ immediately outweighs the remaining time value.", fig.pos='!ht'}
## Bermudan put tree ----
plot_tree(
  V_bm,
  S,
